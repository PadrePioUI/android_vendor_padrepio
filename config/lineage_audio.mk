...
ALARM_PATH := vendor/padrepio/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/padrepio/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/padrepio/prebuilt/common/media/audio/ringtones
